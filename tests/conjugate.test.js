...
const TABLE = [
  ...
  ['먹다', V, '먹어요', '먹었어요', '먹을 거예요', '먹고 싶어요', '안 먹어요', '먹을까요?', '먹어 주세요'],
  ['마시다', V, '마셔요', '마셨어요', '마실 거예요', '마시고 싶어요', '안 마셔요', '마실까요?', '마셔 주세요'],
  ...
  ['돕다', V, '도와요', '도왔어요', '도울 거예요', '돕고 싶어요', '안 도와요', '도울까요?', '도와 주세요'],
  ...
  ['웃다', V, '웃어요', '웃었어요', '웃을 거예요', '웃고 싶어요', '안 웃어요', '웃을까요?', ''],
  ['씻다', V, '씻어요', '씻었어요', '씻을 거예요', '씻고 싶어요', '안 씻어요', '씻을까요?', ''],
  ...
  ['서다', V, '서요', '섰어요', '설 거예요', '', '', '', ''],
  ['건너다', V, '건너요', '건넜어요', '건널 거예요', '건너고 싶어요', '안 건너요', '건널까요?', '건너 주세요'],
