...
(function (M) {
  ...
  const PARTICLES = [
    ...
    { id: 'kkaji', forms: ['까지'], role: 'until', desc: 'means “until” or “up to”' },
    { id: 'euro', forms: ['으로', '로'], role: 'means', desc: 'means “by (means of)” or “toward”' },
    ...
    { id: 'gwa', forms: ['과', '와'], role: 'and', desc: 'means “and” between two nouns' },
  ...
  const HERE = {
    ...
    means: (stem) => `${stem} is the way you do it (or the direction)`,
  ...
  function drills(sentence) {
    ...
    sentence.tiles.forEach((tile, index) => {
      ...
      const here = role === 'place-time' ? placeTimeHere(stem, sentence) : HERE[role](stem);
